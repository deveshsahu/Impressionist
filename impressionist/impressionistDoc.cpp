...
//--****---------------------------------------------------
// Retrieve the current filter type
//---------------------------------------------------------
int ImpressionistDoc::getFilterType()
{
	//m_pCurrentBrush	= ImpBrush::c_pBrushes[type];
	return	m_filterType ;
}
...
//-****----------------------------------------------------------
// Get stroke angle from right mouse drag
//---------------------------------------------------------------

void ImpressionistDoc::getMouseAngle(Point source, Point target)
{
	if ( m_pUI->m_strokeDir2->value())
